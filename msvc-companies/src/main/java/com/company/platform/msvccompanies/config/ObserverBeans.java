...
public class ObserverBeans {
    ...
    @Bean
    public SdkLoggerProvider otelSdkLoggerProvider(Environment env,
                                                   ObjectProvider<LogRecordProcessor> processor) {
        ...
        Attributes attrs = Attributes.builder()
                ...
                .build();
        Resource springResource = Resource.create(attrs);
